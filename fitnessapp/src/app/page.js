    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white p-6">
      ...
      <section className="mb-12 text-center">
        <h1 className="text-5xl font-extrabold mb-4">
          Welcome Back to <span className="text-green-400">FitQuest</span> 🏋️
        </h1>
        <p className="text-gray-300 text-lg max-w-xl mx-auto">
          Your journey to better health starts today. Track workouts, set goals,
        ...
        <div className="bg-gray-900 rounded-lg p-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: "Morning Cardio", detail: "20 min run + jumping jacks" },
            {
              ...
              detail: "Push-ups, squats, deadlifts",
            },
            { title: "Evening Yoga", detail: "15 min breathing + stretch" },
          ].map((workout, index) => (
            <div
              key={index}
              className="p-5 bg-gray-800 rounded-xl shadow hover:bg-gray-700 transition"
            >
